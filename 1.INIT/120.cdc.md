...
Les exigences non-fonctionnelles sont les exigences qui caractérise une propriété désirée du système. Les plus adaptées à notre application seront les exigeances liées à l’environnement du produit (les bâtiments INSA) ainsi que le fonctionnement d’Ins’Access.

## 12. Fonctionnement du produit
### a. Rapidité d’exécution et temps de latence
Le produit a besoin d'une grande rapidité (pour ne pas arriver en retard encore plus) et un petit temps de latence. 
