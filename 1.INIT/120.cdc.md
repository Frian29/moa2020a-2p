...
### a. Maître d’ouvrage
L'équipe d'INS'Access s'occupera de son développement (officiellement l'administration INSA) 
### b. Acheteur
...
Les sites INSA (probablement agenda, moodle) 
...
L'application peut être utilisée partout. En effet les utilisateurs pourront naviguer sur cette dernière à tout moment sans se préoccuper de l'environnement qui les entoure.
### f. ~~De combien de temps les développeurs disposent-ils pour le projet ?~~
Les développeurs disposent de 3 mois pour délivrer la première version du projet.
### g. ~~Quel est le budget affecté au projet ?~~
Le budget affecté au projet sera de 0 euros.(peut être un peu plus si l'INSA est sympa) 
